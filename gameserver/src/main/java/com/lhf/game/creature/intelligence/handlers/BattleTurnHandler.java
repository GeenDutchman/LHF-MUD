...
public class BattleTurnHandler extends AIHandler {
    ...
    public List<Map.Entry<String, Float>> chooseEnemyTarget(BattleMemories battleMemories, CreatureFaction myFaction) {
        SortedMap<String, Float> possTarget = Stream
                .of(this.randomTargetChooser.chooseTarget(battleMemories, myFaction),
                        ...
                        this.aggroHighwaterChooser.chooseTarget(battleMemories, myFaction))
    ...
    public void meleeAttackTargets(BasicAI bai, List<Map.Entry<String, Float>> targetList) {
    ...
    public void handle(BasicAI bai, OutMessage msg) {
        ...
        if (btm.isYesTurn() && bai.getNpc().equals(btm.getMyTurn())) {
            ...
            List<Map.Entry<String, Float>> targetList = this.chooseEnemyTarget(bai.getBattleMemories(),
