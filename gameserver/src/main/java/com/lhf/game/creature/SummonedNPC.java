...
public class SummonedNPC extends WrappedNPC {
    ...
    public SummonedNPC(WrappedNPC NPC, EnumSet<SummonData> summonData, ICreature summoner, Ticker timeLeft) {
        super(NPC);
        this.summonData = summonData;
        this.summoner = summoner;
        this.timeLeft = timeLeft;
    ...
    public void log(Level logLevel, String logMessage) {
        innerNPC.log(logLevel, logMessage != null ? "Summon: " + logMessage : logMessage);
    }
    ...
    public void log(Level logLevel, Supplier<String> logMessageSupplier) {
        Supplier<String> nextSupplier = logMessageSupplier != null ? () -> "Summon: " + logMessageSupplier.get()
                : logMessageSupplier;
        innerNPC.log(logLevel, nextSupplier);
    }
    ...
    public CreatureFaction getFaction() {
        if (this.summoner != null && this.summonData != null) {
            ...
            if (summonerAlive && this.summonData.contains(SummonData.SYMPATHETIC_SUMMON)) {
                ...
                innerNPC.setFaction(this.summoner.getFaction());
                return this.innerNPC.getFaction();
            }
        }
    ...
    public String printDescription() {
        ...
        String description = innerNPC.printDescription();
        if (description == null) {
            return summonString;
        }
