...
public class CastMessageTest {
    ...
    public void testParseAttack() {
        ...
        desired.add(new UnlockedCastMessage("cast turnwaster at boblin").addADirect("turnwaster").addAnIndirect("at",
                "boblin"));
        desired.add(new UnlockedCastMessage("cast \"turnwaster\" at boblin").addADirect("\"turnwaster\"")
                .addAnIndirect("at", "boblin"));
        desired.add(new UnlockedCastMessage("cast \"at locus with nie\" at boblin").addADirect("\"at locus with nie\"")
                .addAnIndirect("at", "boblin"));

        desired.add(
                new UnlockedCastMessage("cast turnwaster with 3").addADirect("turnwaster").addAnIndirect("with", "3"));
        desired.add(new UnlockedCastMessage("cast \"turnwaster\" with 3").addADirect("\"turnwaster\"")
                .addAnIndirect("with", "3"));
        desired.add(new UnlockedCastMessage("cast \"at locus with nie\" with 3").addADirect("\"at locus with nie\"")
                .addAnIndirect("with", "3"));

        desired.add(
                new UnlockedCastMessage("cast turnwaster at boblin with 3").addADirect("turnwaster").addAnIndirect("at",
                        "boblin").addAnIndirect("with", "3"));
