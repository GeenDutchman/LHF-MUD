...
public class PhraseListTest {
    ...
    void testParse() {
        ...
        testcases.add(new GrammarTestCase("oneword twoword", true).addToken("oneword", true).addToken("twoword",
                true));
        testcases.add(new GrammarTestCase("oneword 'midone midtwo' twoword", true).addToken("oneword", true)
                .addToken("'", true)
                .addToken("midone", true).addToken("midtwo", true).addToken("'", true)
                .addToken("twoword", true));
        testcases.add(new GrammarTestCase("oneword 'openquote", false).addToken("oneword", true)
                .addToken("'", true)
                .addToken("openquote", true));
        testcases.add(new GrammarTestCase("here we go"/* to there" */, true).addToken("here", true)
                .addToken("we", true)
