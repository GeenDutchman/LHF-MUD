    ...
    void testParse() {
        ...
        testcases.add(new GrammarTestCase("GO east", true).addToken(CommandMessage.GO.toString(), true)
                .addToken(" ", true).addToken("east",
                        true));
        testcases.add(
                new GrammarTestCase("GO east", true).addToken("go", true).addToken(" ", true).addToken("east", true));
        testcases.add(new GrammarTestCase("SEE", true).addToken("see", true));
        testcases.add(new GrammarTestCase("blarch SEE", false).addToken("blarch", false).addToken(" ", true)
                .addToken("see", true));
        testcases.add(new GrammarTestCase("SAY 'say hello to my', joe to joe", true).addToken("say", true)
                .addToken(" ", true)
                .addToken("'", true).addToken("say", true).addToken(" ", true).addToken("hello", true)
                .addToken(" ", true).addToken("to", true).addToken(" ", true)
                .addToken("my", true).addToken("'", true).addToken(",", true).addToken(" ", true).addToken("joe", true)
                .addToken(" ", true).addToken("to", true).addToken(" ", true)
                .addToken("joe", true));
