...
public class DoorwayTest {
    ...
    void testCanTraverse() throws AtlasException {
        ...
        Mockito.verify(bundle.sssb, Mockito.timeout(1000)).send(Mockito.argThat(hasWest));
        ...
        Mockito.verify(bundle.sssb, Mockito.timeout(1000).times(2)).send(Mockito.argThat(hasWest));
