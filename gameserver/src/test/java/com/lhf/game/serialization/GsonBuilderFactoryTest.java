...
public class GsonBuilderFactoryTest {
        ...
        void testBuild() throws FileNotFoundException {
                ...
                IMonsterBuildInfo builder = Monster.getMonsterBuilder().setName("George").setInventory(georgeInventory);

                RoomBuilder roomBuilder = Room.RoomBuilder.getInstance().addItem(new CarnivorousArmor())
                                .addNPCBuilder(builder)
                                .setName("First Room");
                RoomBuilder nextRoomBuilder = Room.RoomBuilder.getInstance().addItem(new RustyDagger())
                                .setName("Second Room");
                ...
                GsonBuilderFactory gbf = new GsonBuilderFactory().conversation().items().creatureInfoBuilders()
                                .prettyPrinting()
                                .lands().areas();
